...
<h2 class="text-2xl font-semibold text-white dark:text-white text-center">Crear Ticket</h2>
  
<form class="max-w-sm mx-auto" method="POST" action="{{route('tickets.create')}}" >
    @csrf
    <div class="mb-5">
