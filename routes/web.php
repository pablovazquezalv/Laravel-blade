...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/logincode',[UserController::class,'verifiedLoginCode'])->name('login.code')->middleware('vpn.access');//funcion login
    Route::get('/logincode',[ViewController::class,'loginCodeVerifiedView'])->name('login.code.view')->middleware('vpn.access');
