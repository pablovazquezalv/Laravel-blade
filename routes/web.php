...
Route::get('/welcome',[ViewController::class,'welcomeView'])->name('welcome.view')->middleware('auth')->middleware('loginip');#->middleware('status.user')solo en produccion pagina inicio 
...
//TICKETS
Route::middleware(['roles.create:1,2','status.user','auth','loginip'])->group(function () {
